...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="任务调度"]')
        ...
        assert u"任务调度" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTLCZX0008')
        ...
        driver.find_element_by_xpath('//span[text()="批量改派"]').click()
        # # 取消
        # driver.find_element_by_xpath(' //*[@id="app"]//span[contains(text(),"取消")] ').click()
