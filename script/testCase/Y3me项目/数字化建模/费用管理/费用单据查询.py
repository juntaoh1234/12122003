...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="费用单据查询"]')
        ...
        assert u"费用单据查询" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('FICO_DJGL')
        driver.switch_to.frame(iframe)

        # 查询
        driver.find_element_by_xpath('//input[starts-with(@placeholder,"单据")]/following::span[1]/i').click()
