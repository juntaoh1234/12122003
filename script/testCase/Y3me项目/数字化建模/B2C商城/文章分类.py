...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="文章分类"]')
        ...
        assert u"文章分类" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('070701')
        driver.switch_to.frame(iframe)

        # 新增分类
        driver.find_element_by_xpath('//a[@ng-click="classfilyLogic.addItem()"]').click()
        sleep(3)
