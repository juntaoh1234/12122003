...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="首页广告图片"]')
        ...
        assert u"首页广告图片" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('070401')
        driver.switch_to.frame(iframe)

        #保存
        driver.find_element_by_xpath('//button[contains(text(),"保")]').click()
        sleep(3)
