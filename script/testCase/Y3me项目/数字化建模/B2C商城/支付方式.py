...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="支付方式"]')
        ...
        assert u"支付方式" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('0621')
        driver.switch_to.frame(iframe)

        #配置
        driver.find_element_by_xpath('//span[text()="chanpay"]/../..//a[text()="配置"]').click()
        sleep(3)
