...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="打标签"]')
        ...
        assert u"打标签" in titleName, u"页面源码中不存在该关键字！"
        sleep(2)
        iframe = driver.find_element_by_id('SDMB020403')
        driver.switch_to.frame(iframe)

        # 查询
        driver.find_element_by_id('querymembers').click()
        sleep(3)
