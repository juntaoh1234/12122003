...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="会员合并"]')
        ...
        assert u"会员合并" in titleName, u"页面源码中不存在该关键字！"
        sleep(3)
        iframe = driver.find_element_by_id('SDMB020604')
        driver.switch_to.frame(iframe)

        # 合并
        save_button = driver.find_element_by_id('saveActionSelf')
