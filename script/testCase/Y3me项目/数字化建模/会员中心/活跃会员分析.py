...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="活跃会员分析"]')
        ...
        assert u"活跃会员分析" in titleName, u"页面源码中不存在该关键字！"
        sleep(6)
        iframe = driver.find_element_by_id('SDMB120502')
