...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="会员扩展档案"]')
        ...
        assert u"会员扩展档案" in titleName, u"页面源码中不存在该关键字！"
        sleep(2)
        iframe = driver.find_element_by_id('SDMB0606')
        driver.switch_to.frame(iframe)

        # 编辑
        driver.find_element_by_xpath('//td[text()="ext1"]/..//i[@title="编辑"]').click()
        sleep(3)
