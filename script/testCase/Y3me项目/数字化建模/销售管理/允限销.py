...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="允限销"]')
        ...
        assert u"允限销" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('allowlimitSaleLIst')
        driver.switch_to.frame(iframe)

        # 点击组织选择框
        driver.find_element_by_xpath('//span[contains(text(),"组织")]/../..//input').click()
