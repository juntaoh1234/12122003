...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="销售出库"]')
        ...
        assert u"销售出库" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('st_salesout')
        driver.switch_to.frame(iframe)

        # 新增
        driver.find_element_by_xpath('//*[text()="新 增"]/../..//i').click()
        driver.find_element_by_xpath('//*[text()="退货单退货入库"]').click()
