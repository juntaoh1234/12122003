...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="pureBottom bottomBar"][title="云直播"]')
        ...
        assert u"云直播" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTYUNZHIBO001')
        driver.switch_to.frame(iframe)

        # 搜索
        driver.find_element_by_xpath('//input[@placeholder="搜索"]').send_keys("1999")
