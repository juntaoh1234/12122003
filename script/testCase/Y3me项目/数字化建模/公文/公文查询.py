...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="公文查询"]')
        ...
        assert u"公文查询" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTGONGWEN0014')
        driver.switch_to.frame(iframe)

        # 高级查询
        driver.find_element_by_xpath('//div[text()="高级查询"]').click()
