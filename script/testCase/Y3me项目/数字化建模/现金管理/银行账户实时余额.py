...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入一级节点
        menu2 = driver.find_element_by_css_selector('span[title="现金管理"]')
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="银行账户实时余额"]')
        ...
        assert u"银行账户实时余额" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('ficmp0017')
        ...
        # 编辑
        # ActionChains(driver).move_to_element(driver.find_element_by_xpath('//*[text()="现金账户001"]'))
        # driver.find_element_by_xpath('//a[text()="编辑"]').click()
        # driver.find_element_by_id('cmp_initdataxj|btnSave').click()
