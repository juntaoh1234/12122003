...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="基础设置"]')
        ...
        assert u"基础设置" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('service_xtyylj006')
        driver.switch_to.frame(iframe)

        # 集成业务连接服务
        driver.find_element_by_xpath('//div[contains(text(),"集成业务")]').click()
        # 返回
