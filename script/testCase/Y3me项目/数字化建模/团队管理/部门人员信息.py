...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="pureBottom bottomBar"][title="部门人员信息"]')
        ...
        assert u"部门人员信息" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRTD010020')
        driver.switch_to.frame(iframe)

        # 导出花名册

        driver.find_element_by_xpath('//span[text()="导出花名册"]').click()
        sleep(2)
