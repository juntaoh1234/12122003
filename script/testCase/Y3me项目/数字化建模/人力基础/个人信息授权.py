...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="个人信息授权"]')
        ...
        assert u"个人信息授权" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRSZ030060')
        ...
        sleep(1)
        # 点击保存
        driver.find_element_by_xpath('//button[@class="btn btn-primary"]//span[text()="保存"]').click()
        sleep(1)
        # 点击确定
        driver.find_element_by_xpath('//div[@class="buttons"]/button[2]').click()
        sleep(2)
