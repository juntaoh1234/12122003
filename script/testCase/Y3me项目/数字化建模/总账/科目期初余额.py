...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="科目期初余额"]')
        ...
        assert u"科目期初余额" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('balance1')
        driver.switch_to.frame(iframe)

        # 查询
        driver.find_element_by_xpath('//*[text()="试算平衡"]').click()
