...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(6)
        # 点击左侧树按钮
        driver.find_element_by_xpath('//*[@id="app"]//span[text()="合同管理"]').click()
        sleep(3)
        wins0 = driver.window_handles
        # 选中请假
        driver.find_element_by_xpath('//*[@id="app"]//span[text()="劳动合同变更"]').click()
        ...
        driver.find_element_by_xpath('//span[@title="审批"]').doubleClick()
        sleep(3)
