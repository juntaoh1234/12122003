...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(2)
        # 进入二级节点
        driver.find_element_by_xpath('//li[@title="劳动合同终止"]').click()

        sleep(2)
        # 跳转劳动合同签订iframe
        iframe = driver.find_element_by_id('HRGXFW020050')
        ...
        driver.find_element_by_xpath(
            '//*[@id="flowApprove"]//button[@class="btn btn-primary"]/span[text()="新增"]').click()
        sleep(2)
        ...
        # driver.find_element_by_xpath('//*[@id="searchVal"]').send_keys("杨萍")
        # 点击搜索按钮
        ...
        # 点击终止日期
        driver.find_element_by_xpath('//*[@id="edit_20190117135345loEhmuyM47"]/div/span[1]').click()
        driver.find_element_by_xpath(
        ...
        driver.find_element_by_xpath('//*[@id="20190117135411EseDY5HvBN"]').send_keys(paragraph)

        # 点击保存按钮
        driver.find_element_by_xpath('//*[@id="templatePanel"]//span[text()="保存"]').click()
        sleep(3)
