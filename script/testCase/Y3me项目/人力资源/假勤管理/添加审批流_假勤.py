...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(6)
        # 点击左侧树按钮
        driver.find_element_by_xpath('//*[@id="app"]//span[text()="假勤管理"]').click()
        sleep(3)
        wins0 = driver.window_handles
        # 选中请假
        driver.find_element_by_xpath('//*[@id="app"]//span[text()="请假"]').click()
        ...
        ele = driver.find_element_by_xpath(
            '//div[@class="main-person"]/div[@class="scroll-content-horizonal ps ps--active-y"]/div[4]/div')
        action.drag_and_drop_by_offset(ele, 1, 110)
        action.perform()
        sleep(1)
        # 点击审批流的发起人
        driver.find_element_by_xpath(
            '//span[text()="发起人"]/preceding-sibling::span/span').click()
