...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		sleep(1)
		# 进入二级节点
		driver.find_element_by_xpath('//li[@title="出差规则"]').click()

		sleep(2)
		# 跳转劳动合同签订iframe
		iframe = driver.find_element_by_id('HRJQ020080')
		...
		sleep(2)
		# 点击所属组织右侧按钮
		driver.find_element_by_xpath('//*[@id="c55"]/div/span/span/span/i[2]').click()
		sleep(3)# 选择北京仓储中心
		...
		str_gz = "规则{}".format(num)
		driver.find_element_by_xpath('//label[text()="规则名称"]/ancestor::div[@class="el-form-item is-required"]//input').send_keys(str_gz)

		# 备注信息
		driver.find_element_by_xpath('//*[@id="basicInfo"]//textarea').send_keys("新增加班规则")

		# 点击保存
		driver.find_element_by_xpath('//button[@class="el-button el-button--primary"]/span[text()="保存"]').click()
		sleep(2)

		self.assertIn(str_gz,driver.page_source)
		# 编辑考勤规则
		driver.find_element_by_xpath('//button[@class="el-button el-button--primary"]/span[text()="编辑"]').click()
		sleep(2)
		# 点击保存按钮
		driver.find_element_by_xpath('//button[@class="el-button el-button--primary"]/span[text()="保存"]').click()
		...
		sleep(1)
		ele = driver.find_element_by_xpath('//*[@id="home_header"]/div/div[3]/ul/li/p')
		action = ActionChains(driver)
		action.move_to_element(ele)
		action.perform()
		driver.find_element_by_xpath('//*[@id="home_header"]/div/div[3]/ul/li/div[2]/div/button[1]/i').click()
		...
		driver.find_element_by_xpath(
			'//div[text()="{}"]/ancestor::tr/td[4]/div/div[2]'.format(str_gz)).click()
		sleep(1)
		# 点击确认
		driver.find_element_by_xpath(
		...
		# 点击删除按钮
		driver.find_element_by_xpath(
			'//div[text()="{}"]/ancestor::tr/td[4]/div/div[3]'.format(str_gz)).click()
		...
		# 断言是否删除成功
		sleep(2)
		self.assertNotIn(str_gz,driver.page_source)
		# 关闭当前页面
		driver.switch_to.default_content()
		sleep(1)
