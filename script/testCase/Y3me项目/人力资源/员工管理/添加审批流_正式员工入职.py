...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        # 选中请假
        driver.find_element_by_xpath('//*[@id="app"]//span[text()="正式员工入职"]').click()
        ...
        driver.find_element_by_xpath('//span[@title="入职审批-主管"]').doubleClick()
        sleep(3)
        ...
        # 双击BP_header
        # driver.find_element_by_xpath('//*[@id="app"]/div/div/div/div[1]/div[2]/button[2]').click()
        driver.find_element_by_xpath('//span[@title="入职审批-BP Head"]').doubleClick()
        sleep(3)
        action = ActionChains(driver)
        ele = driver.find_element_by_xpath(
            '//*[@id="app"]/div/div/div/div[4]/div/div/div[2]/div[2]/div[1]/div/div[4]/div')
        ...
        # 双击入职办理
        # driver.find_element_by_xpath('//*[@id="app"]/div/div/div/div[1]/div[2]/button[2]').click()
        driver.find_element_by_xpath('//span[@title="发送Offer"]').doubleClick()
        sleep(3)
        action = ActionChains(driver)
        ele = driver.find_element_by_xpath(
            '//*[@id="app"]/div/div/div/div[4]/div/div/div[2]/div[2]/div[1]/div/div[4]/div')
        ...
        # 双击入职办理
        # driver.find_element_by_xpath('//*[@id="app"]/div/div/div/div[1]/div[2]/button[2]').click()
        driver.find_element_by_xpath('//span[@title="入职办理"]').doubleClick()
        sleep(3)
        action = ActionChains(driver)
        ele = driver.find_element_by_xpath(
            '//*[@id="app"]/div/div/div/div[4]/div/div/div[2]/div[2]/div[1]/div/div[4]/div')
