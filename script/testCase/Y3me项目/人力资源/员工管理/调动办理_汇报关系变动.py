...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		# 点击试用期转正
		driver.find_element_by_xpath('//*[@id="staffchange-info-content"]//button[text()="汇报关系变动"]').click()
		...
		# 选择变动原因
		driver.find_element_by_xpath('//span[text()="变动原因"]/ancestor::div[@class="innerContainer"]//td[text()="3002002"]').click()
		...
		driver.find_element_by_xpath('//*[@id="edit_20180605144233owHkX1lVku"]/div/div/div[1]/div/div/div[3]/div[18]').click()
		...
		# 点击提交按钮
		sleep(3)
		driver.find_element_by_xpath('//button[@class="btn btn-primary"]/span[@data-bind="text: editFlag.button"]').click()
		sleep(2)
		# 关闭当前页面
