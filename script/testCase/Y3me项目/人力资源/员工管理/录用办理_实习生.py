...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        # 点击实习生入职
        driver.find_element_by_xpath('//div[@class="staff-info-control-btn fr"]/button[text()="实习生入职"]').click()
        ...
        # 选择证件类型，点击右侧按钮
        driver.find_element_by_xpath('//*[@id="edit_20181009204747YWFw2liMwv"]/div/span[1]').click()
        # 选择身份证类型
        ...
        # 选择学历信息
        driver.find_element_by_xpath(
            '//div[@class="scroll-wrapper fixed-table-body scrollbar-dynamic"]//td[text()="博士后"]').click()
        ...
        # 点击所属部门
        driver.find_element_by_xpath('//*[@id="20180509105133pTCmKwGwPQ"]').send_keys("仓储中心")
        driver.find_element_by_xpath('//*[@id="20180509105133pTCmKwGwPQ"]').click()
        sleep(2)
        driver.find_element_by_xpath('//*[@id="20180509105133pTCmKwGwPQ"]').send_keys(Keys.ENTER)

        # 输入日薪
        driver.find_element_by_xpath('//*[@id="20180509105133gSQtBR2Ckf"]').send_keys("10000")
