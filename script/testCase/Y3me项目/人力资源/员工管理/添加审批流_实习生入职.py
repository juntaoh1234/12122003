...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        # 选中请假
        driver.find_element_by_xpath('//*[@id="app"]//span[text()="实习生入职"]').click()
        ...
        driver.find_element_by_xpath('//span[@title="入职审批"]').doubleClick()
        sleep(3)
        ...
        # 双击BP_header
        # driver.find_element_by_xpath('//*[@id="app"]/div/div/div/div[1]/div[2]/button[2]').click()
        driver.find_element_by_xpath('//span[@title="入职审批-BP"]').doubleClick()
        sleep(3)
        action = ActionChains(driver)
        ele = driver.find_element_by_xpath(
            '//*[@id="app"]/div/div/div/div[4]/div/div/div[2]/div[2]/div[1]/div/div[4]/div')
