...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="打卡原始记录"]')
        ...
        assert u"打卡原始记录" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRJQ010020')
        driver.switch_to.frame(iframe)

        # 查询
        driver.find_element_by_xpath('//li[contains(text(),"补考勤记录")]').click()
