...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="假勤日月报"]')
        ...
        assert u"假勤日月报" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRJQ010010')
        driver.switch_to.frame(iframe)

        # 查询
        driver.find_element_by_xpath('//li[contains(text(),"月报")]').click()
        search_button = driver.find_element_by_xpath('//span[text()="查询"]')
