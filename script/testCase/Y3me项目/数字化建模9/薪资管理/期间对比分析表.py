...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="期间对比分析表"]')
        ...
        assert u"期间对比分析表" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRXC070030')
        driver.switch_to.frame(iframe)

        # 点击所属组织选择框
        driver.find_element_by_xpath('//input[@placeholder="所属组织"]/..//i[2]').click()
