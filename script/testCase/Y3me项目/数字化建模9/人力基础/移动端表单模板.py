...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="移动端表单模板"]')
        ...
        assert u"移动端表单模板" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRSZ040021')
        driver.switch_to.frame(iframe)

        # 点击转正
        driver.find_element_by_xpath('//*[text()="转正"]').click()
