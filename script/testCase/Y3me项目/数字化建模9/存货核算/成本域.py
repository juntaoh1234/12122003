...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="成本域"]')
        ...
        assert u"成本域" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('fiia0102')
        driver.switch_to.frame(iframe)
        # 新增
        driver.find_element_by_id('ia_costdomainlist|btnAdd').click()
