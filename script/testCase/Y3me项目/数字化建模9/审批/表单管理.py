...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="表单管理"]')
        ...
        assert u"表单管理" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTLCZX0004')
        driver.switch_to.frame(iframe)

        # 新建表单
        driver.find_element_by_xpath('//a[text()="新建表单"]').click()
        # 取消
