...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="工作台"]')
        ...
        assert u"工作台" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTLCZX0001')
        driver.switch_to.frame(iframe)

        # 收藏
        s_button = driver.find_element_by_xpath('//span[text()=" 收藏 "]')
