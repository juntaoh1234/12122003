...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="商旅订单中心"]')
        ...
        assert u"商旅订单中心" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('FICO_SLDDZX')
        driver.switch_to.frame(iframe)

        # 查询
        button_search = driver.find_element_by_xpath('//*[text()="查 询"]')
