...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="借款期初"]')
        ...
        assert u"借款期初" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('FICO_JKQC')
        driver.switch_to.frame(iframe)

        # 查询
        button_search = driver.find_element_by_xpath('//*[starts-with(text(),"展开")]/../following::button/span[text()="查 询"]')
