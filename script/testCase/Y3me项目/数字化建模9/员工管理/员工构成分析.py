...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="员工构成分析"]')
        ...
        assert u"员工构成分析" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('HRPA090')
        driver.switch_to.frame(iframe)
        # 点击所属组织选择框
        driver.find_element_by_xpath('//span[text()="所属组织："]/../div//span').click()
