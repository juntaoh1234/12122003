...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="pureBottom bottomBar"][title="订阅号"]')
        ...
        assert u"订阅号" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTDYH0001')
        driver.switch_to.frame(iframe)

        # 创建公共号
        driver.find_element_by_xpath('//a[@class="create-ico"]/i').click()
        driver.find_element_by_xpath('//label[text()="账号"]/..//input').send_keys("yonyou")
        driver.find_element_by_xpath('//label[text()="名称"]/..//input').send_keys("用友公共号001")
