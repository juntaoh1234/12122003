...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="pureBottom bottomBar"][title="投票"]')
        ...
        assert u"投票" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('XTTOUPIAO000000000')
        driver.switch_to.frame(iframe)

        # 创建话题
        driver.find_element_by_xpath('//div[text()=" ＋ 发起投票"]').click()
        sleep(3)
