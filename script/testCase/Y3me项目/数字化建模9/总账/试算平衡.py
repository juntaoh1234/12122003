...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="试算平衡"]')
        ...
        assert u"试算平衡" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('trial')
        driver.switch_to.frame(iframe)

        # 点击包含未记帐单按钮
        driver.find_element_by_xpath('//input[@value="包含未记账凭证"]').click()
