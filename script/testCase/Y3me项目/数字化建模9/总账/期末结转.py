...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="期末结转"]')
        ...
        assert u"期末结转" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('carryover')
        driver.switch_to.frame(iframe)

        # 点击凭证号整理
        driver.find_element_by_xpath('//button[text()="凭证号整理"]').click()
