...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="总账结账"]')
        ...
        assert u"总账结账" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('checkout')
        driver.switch_to.frame(iframe)

        # 点击凭证号整理
        driver.find_element_by_xpath('//button[text()="结账检查"]').click()
        sleep(3)
