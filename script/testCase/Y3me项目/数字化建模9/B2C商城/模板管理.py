...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="模板管理"]')
        ...
        assert u"模板管理" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('070101')
        driver.switch_to.frame(iframe)

        # 模板下载
        driver.find_element_by_xpath('//button[text()="模板下载"]').click()
        sleep(3)
