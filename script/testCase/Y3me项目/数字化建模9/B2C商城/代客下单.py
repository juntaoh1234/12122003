...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="代客下单"]')
        ...
        assert u"代客下单" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('0240')
        driver.switch_to.frame(iframe)

        #创建会员
        driver.find_element_by_xpath('//button[text()="创建会员"]').click()
        sleep(3)
        # 取消
