...
class EasyCase(TestCase):
    ...
    def runTest(self):
        ...
        sleep(3)
        # 进入二级节点
        menu3 = driver.find_element_by_css_selector('li[class="bottomBar"][title="SEO设置"]')
        ...
        assert u"SEO设置" in titleName, u"页面源码中不存在该关键字！"
        sleep(5)
        iframe = driver.find_element_by_id('071001')
        driver.switch_to.frame(iframe)

        # 编辑
        driver.find_element_by_xpath('//tbody/tr[1]//a[text()="编辑"]').click()
        sleep(3)
